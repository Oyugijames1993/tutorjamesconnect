      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.inputGroup}>
            ...
            <input style={styles.input} type="text" name="specialisation"
              placeholder="e.g. Mathematics, Python, Web Design"
              value={form.specialisation} onChange={handleChange} required />
          </div>

          <div style={styles.inputGroup}>
            <label style={styles.label}>Bio</label>
            <textarea style={styles.textarea} name="bio"
              placeholder="Tell clients about your experience and teaching style..."
...
const styles = {
  container: {
    minHeight: '100vh',
    background: 'linear-gradient(135deg, #1a7a4a 0%, #0d4a2e 100%)',
    display: 'flex',
    alignItems: 'center',
  ...
  header: {
    ...
    marginBottom: '24px',
    padding: '16px',
    background: 'linear-gradient(135deg, #1a7a4a, #0d4a2e)',
    borderRadius: '12px',
  },
  title: {
    color: '#ffffff',
